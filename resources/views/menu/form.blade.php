...
<div class="modal fade" id="modalFormImportMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">menu</h5>
            ...
            <div class="modal-body">
                <form method="post" action="{{url('import-menu')}}" class="form" enctype="multipart/form-data">
                    @csrf
                    <div id="method"></div>
